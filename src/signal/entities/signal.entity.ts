...
export enum SignalType {
  ...
  MINERVINI_VCP_BASE = 'MINERVINI_VCP_BASE',
  MINERVINI_PIVOT_BREAKOUT = 'MINERVINI_PIVOT_BREAKOUT',
  MINERVINI_VOLUME_CONFIRM = 'MINERVINI_VOLUME_CONFIRM',
  MINERVINI_BUY_ZONE = 'MINERVINI_BUY_ZONE',
  MINERVINI_EXTENDED = 'MINERVINI_EXTENDED',
